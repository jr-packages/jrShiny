...
## Exercise 2 (5 minutes)
  ...
  * Run the command `jrShiny::create_project()`. This should create two directories: `original`
  and `exercises`.
  * Open `chapter1/shiny2.Rmd` and run the script. 
...
## Exercise 3 (5 minutes)
  ...
  * Open `chapter1/shiny3.Rmd` and run. 
  * Include the line
    ```{r eval=FALSE}
...
## Exercise 4 (5 minutes)
  ...
  * Open `chapter1/shiny4a.Rmd` and run. 
    ...
    * Let the slider determine the value of `n` in an `rnorm` call, i.e. `rnorm(input$n)`. Using
    ...
    a slider.
  * Open `chapter1/shiny4b.Rmd` and run. 
...
## Exercise 5
  ...
  * Open `chapter1/shiny5.Rmd` and run. 
...
## Exercise 6
  ...
  * Open `chapter1/shiny6.Rmd` and run. 
...
## Exercise 7
  ...
  * Open `chapter1/shiny7.Rmd` and run. 
...
shiny components. These examples are found in `chapter1/` and the files start with `Why_`.
